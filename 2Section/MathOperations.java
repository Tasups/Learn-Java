public class MathOperations {
    public static void main(String[] args) {
        ...
        System.out.println("George has " + (bagOfSweets2 - bagOfSweets1) + " more sweets than Fred.");
        ...
        System.out.println("Snape caught the error. Furious, he divided Ron's score to: " + (testScore / 1.2) + ".");
