...
public class Main {
    public static void main(String[] args) {
        ...
        sciFiMovies.forEach(movie -> System.out.println(movie.toString()));
    
        System.out.println("\nSorted by Release Year:");
        sortedMovies.forEach(movie -> System.out.println(movie.toString()));
    
        System.out.println("\nTop Rated Movies:");
        topRatedMovies.forEach(movie -> System.out.println(movie.toString()));
