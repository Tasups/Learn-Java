...
public class Car {
    ...
    public void setProductionYear(int productionYear) {
        if (productionYear < MIN_YEAR) {
            throw new IllegalArgumentException("Production year must be equal to or higher than 1900");
        }
    ...
    public void setPrice(double price) {
        if (price <= MIN_PRICE || price > MAX_PRICE) {
            throw new IllegalArgumentException("Price cannot be equal to or less than zero or over $200,000");
        }
        this.price = price;
    }
    
    public String toString() {
        return "This " + this.productionYear + " " + this.make + " " + this.model + " is on sale for $" + this.price;
    }
